...
namespace MCInvoiceAddQBFC.Session_Framework
{
    public class SessionManager
    {
        ...
        public static SessionManager getInstance(bool forceCreation = true)
        {
            if (sessionMgr == null && forceCreation)
            {
                sessionMgr = new SessionManager();
                sessionMgr.initialize(SessionManager.AppName ?? Defaults.APPNAME, SessionManager.AppID ?? Defaults.APPID, Defaults.CONNECTION_TYPE);
            }
